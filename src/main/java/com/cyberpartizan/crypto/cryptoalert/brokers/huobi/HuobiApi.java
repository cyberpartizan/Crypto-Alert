package com.cyberpartizan.crypto.cryptoalert.brokers.huobi;
...
import static com.cyberpartizan.crypto.cryptoalert.brokers.huobi.HuobiUtils.URL;
import static com.cyberpartizan.crypto.cryptoalert.models.BrokerEnum.HUOBI;

@Component
public class HuobiApi implements BrokerApi {
    ...
    public List<TickerBase> getTickers() throws IOException {
        ...
        tickerList.forEach(e -> e.setBroker(HUOBI));
